...
#ifndef HP_SERVER_SOCKET_H
#define HP_SERVER_SOCKET_H
class hp_server_socket {

public:
	hp_server_socket(int port, int domain, int type, int protocol ,int num_front = 100); //constructor for AF_INET type socket
	hp_server_socket(int domain, int type, int protocol, std::string listen_on ,int num_front = 100); //constructor for AF_UNIX type socket
