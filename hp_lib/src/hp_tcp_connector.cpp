...
#include <fcntl.h>
#include <errno.h>
#include "../include/hp_tcp_connector.h"

hp_tcp_stream* hp_tcp_connector::connect(const char* server, int port)
{
...
hp_tcp_stream* hp_tcp_connector::connect(const char* server, int port, int timeout)
{
...
int hp_tcp_connector::resolveHostName(const char* hostname, struct in_addr* addr) 
{
    struct addrinfo *res;
